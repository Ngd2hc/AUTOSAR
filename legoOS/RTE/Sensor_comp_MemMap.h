...
#elif defined(Sensor_comp_START_SEC_CODE)
#undef Sensor_comp_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(Sensor_comp_STOP_SEC_CODE)
#undef Sensor_comp_STOP_SEC_CODE
